let devmod=true,
    ...
    listKeyPressed=[],
    onPause=false,
    themeMusic=new Audio('https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/audio/music-map1.ogg');
...
mapMask.src = "https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/map-1-mask.png";
document.getElementsByTagName('map')[0].style.backgroundImage='url("https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/'+mapName+'c.png")'
...
class game {
    ...
    static recommencer(){
        location="https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/race.html";
    }

    static quitter(){
        location="https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/main.html";
    }
...
class map{
    ...
    static readJsonFile(fileName, callback) {
        ...
        rawFile.open("GET", "https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/"+fileName+".json", true);
...
class music {
    ...
    static playSound(name, volume, rate = 1) {
        if(!music.listPlayer[name]){
            music.listPlayer[name]=new Audio('https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/audio/' + name + '.ogg');
        }else{
            if(music.listPlayer[name].played){
                let audio = new Audio('https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/audio/' + name + '.ogg');
    ...
    resume(){
        ...
        this.loopRefresh=setInterval(() => {
            ...
            /*if(0 && !this.engineSound && firstInteract){
                this.engineSound=1
                loadSample('https://www.sashimi.zip/MrTakedi/Mario-Kart-html/main/demo/src/audio/engine3.ogg')
                    .then(sample => {
